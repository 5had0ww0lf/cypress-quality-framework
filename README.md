...
- Maintainable project structure designed to scale into visual regression, Lighthouse auditing, and API testing
...
- `cypress/e2e/visual/` — visual regression with baseline management
